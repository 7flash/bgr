  ...
  return (
    <div>
      ...
      <div className="stats-grid" id="stats-grid">
        ...
        <div
          className="stat-card running stat-clickable"
          data-stat-filter="running"
        >
          <div className="stat-label">Running</div>
          <div className="stat-value" id="running-count">
            –
          </div>
        </div>
        <div
          className="stat-card stopped stat-clickable"
          data-stat-filter="stopped"
        >
          <div className="stat-label">Stopped</div>
          <div className="stat-value" id="stopped-count">
            –
          </div>
        </div>
        <div
          className="stat-card guarded stat-clickable"
          data-stat-filter="guarded"
        >
          <div className="stat-label">Guarded</div>
          <div className="stat-value" id="guarded-count">
            –
          </div>
        </div>
        <div className="stat-card memory">
          <div className="stat-label">Total Memory</div>
          <div className="stat-value" id="memory-count">
            –
          </div>
        </div>
        <div className="stat-card restarts">
          <div className="stat-label">Guard Restarts</div>
          <div className="stat-value" id="restarts-count">
            0
          </div>
        </div>
        <div className="stat-card uptime">
          <div className="stat-label">Longest Uptime</div>
          <div className="stat-value" id="uptime-longest">
            –
          </div>
        </div>
        <div className="stat-card uptime-total">
          <div className="stat-label">Total Uptime</div>
          <div className="stat-value" id="uptime-total">
            –
          </div>
        </div>
      </div>
      ...
      <div className="guard-activity" id="guard-activity">
        <div className="guard-activity-header">
          ...
          <span className="guard-activity-empty" id="guard-activity-empty">
            No recent activity
          </span>
        </div>
      ...
      <div className="toolbar">
        <div className="toolbar-left">
          <div className="toolbar-brand">
            ...
            <h2>bgrun</h2>
            <span className="version-badge" id="version-badge">
              ...
            </span>
          </div>
          ...
          <span
            className="stat-filter-badge"
            id="stat-filter-badge"
            style={{ display: "none" }}
          >
            <span id="stat-filter-badge-label"></span>
            <button
              className="stat-filter-badge-clear"
              id="stat-filter-badge-clear"
              type="button"
        ...
        <div className="toolbar-right">
          ...
          <button
            className="btn btn-ghost btn-guard-all"
            id="guard-all-btn"
            title="Guard All Processes"
          >
            <svg
              viewBox="0 0 24 24"
              fill="none"
          ...
          <button
            ...
            id="deploy-all-btn"
            title="Git pull + restart all deployable processes"
          >
            <svg
              viewBox="0 0 24 24"
              fill="none"
          ...
          <div className="deploy-controls">
            <label
              className="deploy-concurrency-wrap"
              title="Bulk deploy concurrency (saved per group)"
            >
              <span className="deploy-concurrency-label">Deploy</span>
              <select
                className="deploy-concurrency-select"
                id="deploy-concurrency-select"
              >
            ...
            <span
              className="deploy-preset-source"
              id="deploy-preset-source"
              title="Current deploy preset source"
            >
              default
            </span>
            <button
              className="btn btn-ghost btn-icon"
              id="deploy-preset-reset-btn"
              title="Reset saved deploy preset for current group"
            >
              <svg
                viewBox="0 0 24 24"
                fill="none"
          ...
          >
            <span id="theme-toggle-icon" style={{ fontSize: "0.85rem" }}>
              🌙
            </span>
          </button>
          <button
      ...
      <div className="detail-drawer" id="detail-drawer">
        ...
        <div className="drawer-header">
          ...
          <button className="drawer-close" id="drawer-close-btn">
            ✕
          </button>
        </div>
          ...
          <div className="accordion-section" id="accordion-config">
            ...
            <div className="accordion-body">
              <div className="accordion-subtabs" id="config-subtabs">
                <button className="accordion-subtab active" data-subtab="toml">
                  config.toml
                </button>
                <button className="accordion-subtab" data-subtab="env">
                  ENV
                </button>
              </div>
          ...
          <div className="accordion-section open" id="accordion-logs">
            ...
            <div className="accordion-body accordion-body-logs">
              <div className="accordion-subtabs" id="log-subtabs">
                <button
                  className="accordion-subtab active"
                  data-subtab="stdout"
                >
                  stdout
                </button>
              ...
              <div className="drawer-logs" id="drawer-logs">
                No logs loaded
              </div>
            </div>
          </div>
        ...
        <div className="modal">
          ...
          <div className="modal-body">
            ...
            <div className="form-group">
              ...
              <input
                type="text"
                id="process-directory-input"
                placeholder="/path/to/project"
              />
            </div>
            <div className="form-group">
              <label htmlFor="process-port-input">
                Port{" "}
              ...
              <div className="port-input-wrap">
                ...
                <button
                  ...
                  id="suggest-port-btn"
                  type="button"
                  title="Auto-assign next available port"
                >
                  Suggest
                </button>
              </div>
          ...
          <div className="modal-footer">
            <button className="btn btn-ghost" id="modal-cancel-btn">
              Cancel
            </button>
            <button className="btn btn-primary" id="modal-create-btn">
              Create
            </button>
          </div>
        </div>
      ...
      <div className="modal-overlay" id="deps-modal">
        <div className="modal modal-wide">
          <div className="modal-header">
            ...
            <button className="modal-close" id="deps-modal-close">
              ✕
            </button>
          </div>
          <div className="modal-body">
            <div className="deps-controls">
              ...
              <button className="btn btn-primary btn-sm" id="deps-add-btn">
                Add
              </button>
            </div>
      ...
      <div className="modal-overlay" id="history-modal">
        <div className="modal modal-wide">
          <div className="modal-header">
            ...
            <button className="modal-close" id="history-modal-close">
              ✕
            </button>
          </div>
          <div className="modal-body">
            <div className="history-filters">
              ...
              <input
                ...
                className="history-select history-search"
                type="text"
                placeholder="Filter metadata (comma-separated)..."
              />
              <label
                className="history-density-wrap"
                title="History row density"
              >
                <span className="history-density-label">Density</span>
                <select
                  id="history-density-select"
                  className="history-select history-density-select"
                >
              ...
              <label
                className="history-shortcuts-toggle"
                title="Show quick-action affordances in History rows"
              >
              ...
              <label
                className="history-density-wrap"
                title="Default History details state"
              >
                <span className="history-density-label">Details</span>
                <select
                  id="history-details-default-select"
                  className="history-select history-density-select"
                >
              ...
              <button
                ...
                title="Clear all history filters"
              >
                Clear
              </button>
              <div className="toolbar-export-actions">
            ...
            <div className="history-hints-bar">
              <div className="history-hints-bar-left">
                ...
                <div className="history-focus-controls">
                  <button
                    className="history-focus-jump"
                    id="history-focus-prev"
                    type="button"
                    title="Focus previous History row"
                  >
                    ←
                  </button>
                  <span
                    className="history-focus-status"
                    id="history-focus-status"
                  >
                    No row selected
                  </span>
                  <button
                    className="history-focus-jump"
                    id="history-focus-next"
                    type="button"
                    title="Focus next History row"
                  >
                    →
                  </button>
                </div>
                <label
                  className="history-auto-open-toggle"
                  title="Automatically sync the process drawer while stepping through History rows"
                >
                  <input id="history-auto-open-toggle" type="checkbox" />
                  <span>Auto-open</span>
                </label>
                <label
                  className="history-hint-density-wrap"
                  title="Auto-open behavior while stepping through History rows"
                >
                  <span className="history-density-label">Scope</span>
                  <select
                    id="history-focus-scope-select"
                    className="history-select history-hint-density-select"
                  >
              ...
              <div className="history-hints-actions">
                <label
                  className="history-hint-density-wrap"
                  title="Keyboard hint density"
                >
                  <span className="history-density-label">Hints</span>
                  <select
                    id="history-hint-density-select"
                    className="history-select history-hint-density-select"
                  >
                ...
                <details className="history-hint-groups-menu">
                  <summary
                    className="history-hints-toggle"
                    title="Choose which History hint groups to show"
                  >
                    Groups
                  </summary>
                  <div className="history-hint-groups-panel">
                    <div className="history-hint-presets">
                      <button
                        className="history-hint-preset"
                        type="button"
                        data-history-hint-preset="minimal"
                      >
                        Minimal
                      </button>
                      <button
                        className="history-hint-preset"
                        type="button"
                        data-history-hint-preset="navigation"
                      >
                        Navigation
                      </button>
                      <button
                        className="history-hint-preset"
                        type="button"
                        data-history-hint-preset="all"
                      >
                        All
                      </button>
                      <span
                        className="history-hint-preset-state"
                        id="history-hint-preset-state"
                      >
                        Custom
                      </span>
                    </div>
                    <label className="history-hint-group-option">
                      <input id="history-hint-group-nav" type="checkbox" />{" "}
                      <span>Navigation</span>
                    </label>
                    <label className="history-hint-group-option">
                      <input id="history-hint-group-open" type="checkbox" />{" "}
                      <span>Open</span>
                    </label>
                    <label className="history-hint-group-option">
                      <input id="history-hint-group-filter" type="checkbox" />{" "}
                      <span>Filters</span>
                    </label>
                    <label className="history-hint-group-option">
                      <input id="history-hint-group-details" type="checkbox" />{" "}
                      <span>Details</span>
                    </label>
                    <label className="history-hint-group-option">
                      <input id="history-hint-group-close" type="checkbox" />{" "}
                      <span>Close</span>
                    </label>
                  </div>
                </details>
                <button
                  className="history-hints-toggle"
                  id="history-hints-toggle"
                  type="button"
                  title="Hide keyboard shortcut hints"
                >
                  Hide
                </button>
              </div>
            ...
            <div
              className="history-keyboard-hints"
              id="history-keyboard-hints"
              aria-label="History keyboard shortcuts"
            >
              <span className="history-keyboard-hint" data-hint-group="nav">
                <kbd>↑</kbd>
                <kbd>↓</kbd>
                <span>Move</span>
              </span>
              <span className="history-keyboard-hint" data-hint-group="open">
                <kbd>Enter</kbd>
                <span>Open</span>
              </span>
              <span className="history-keyboard-hint" data-hint-group="filter">
                <kbd>F</kbd>
              ...
              <span className="history-keyboard-hint" data-hint-group="details">
                <kbd>Space</kbd>
                <span>Toggle details</span>
              </span>
              <span className="history-keyboard-hint" data-hint-group="close">
                <kbd>Esc</kbd>
                <span>Close</span>
              </span>
            </div>
      ...
      <div className="modal-overlay" id="templates-modal">
        <div className="modal modal-wide">
          <div className="modal-header">
            ...
            <button className="modal-close" id="templates-modal-close">
              ✕
            </button>
          </div>
          <div className="modal-body">
            <div className="templates-form">
              ...
              <div className="form-group">
                <label htmlFor="template-env">
                  Environment (KEY=VAL,KEY2=VAL2)
                </label>
                <input
                  type="text"
                  id="template-env"
                  placeholder="BGR_KEEP_ALIVE=true,PORT=3000"
                />
              </div>
              <div className="templates-actions">
                <button className="btn btn-primary" id="template-save-btn">
                  Save Template
                </button>
              </div>
            </div>
      ...
      <div className="modal-overlay" id="deploy-results-modal">
        <div className="modal modal-wide">
          <div className="modal-header">
            ...
            <button className="modal-close" id="deploy-results-modal-close">
              ✕
            </button>
          </div>
          <div className="modal-body">
            ...
            <div className="deploy-results-list" id="deploy-results-list">
              <div className="history-empty">
                Run a bulk deploy to see detailed results
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="shortcuts-overlay" id="shortcuts-overlay">
        <div className="shortcuts-panel">
          <div className="shortcuts-header">
            ...
            <button className="shortcuts-close" id="shortcuts-close-btn">
              ✕
            </button>
          </div>
          <div className="shortcuts-grid">
            <div className="shortcut-section">
              ...
              <div className="shortcut-row">
                <kbd>↑</kbd>
                <kbd>↓</kbd>
                <span>Navigate processes</span>
              </div>
              <div className="shortcut-row">
                <kbd>Enter</kbd>
                <span>Open process drawer</span>
              </div>
              <div className="shortcut-row">
                <kbd>/</kbd>
